          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div>
              ...
              <h1 className="mt-1 text-2xl font-black text-gray-900 md:text-3xl">
                My Achievement Overview
              </h1>

              <p className="mt-1 text-sm text-gray-600">
                Track your submissions and monitor admin verification status.
              </p>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              ...
              {achievements.slice(0, 6).map((item) => (
                ...
                <Link
                  ...
                  key={item.id}
                  className="brand-card p-5 transition hover:-translate-y-0.5"
                >
                  ...
                  <div className="mb-3 flex items-start justify-between gap-2">
                    ...
                    <span
                      className={`rounded-full px-3 py-1 text-xs font-semibold ${chipStyles[item.status]}`}
                    >
                      {item.status}
                    </span>
